...
func _ready():
	...
	# atlas cells at distance, which shows up as thin see-through seams/gaps
	# between blocks ("просвет блоков"). Plain NEAREST samples one texel with no
	# cross-cell interpolation -- standard for blocky/voxel games.
